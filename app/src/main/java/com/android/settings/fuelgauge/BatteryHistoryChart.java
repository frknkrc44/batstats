...
public class BatteryHistoryChart extends View {
    ...
    public BatteryHistoryChart(Context context, AttributeSet attrs) {
        ...
        int textSize = (int) (15 * getResources().getDisplayMetrics().density);
        int typefaceIndex = -1;
        int styleIndex = -1;
        ...
        if (textColor == null) {
            ...
            setTextColor(arr.getColor(0, 0xFF000000));
        } else {
    ...
    public void setStats(BatteryStats stats) {
        ...
        mHaveWifi = (aggrStates&HistoryItem.STATE_WIFI_RADIO_ACTIVE_FLAG) != 0;
        mHavePhoneSignal = !isWifiOnly();
                ...
                if (rec.cmd == BatteryStats.HistoryItem.CMD_UPDATE) {
                    ...
                    if (lastX != x) {
                        ...
                        final boolean wifiRunning =
                            (rec.states&HistoryItem.STATE_WIFI_RADIO_ACTIVE_FLAG) != 0;
